...
//https://blog.csdn.net/ywch520/article/details/87877946
//https://github.com/llgcode/draw2d.git
//https://github.com/golang/freetype.git

//https://github.com/golang/image.git
//解决方法一： 新增golang.org/x/包；git clone github.com/golang/依赖 到x文件下。
//解决方法二： 更改依赖包为github.com/golang/包； git clone 依赖。
//方法一不需要更改第三方库
