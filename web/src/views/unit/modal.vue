  ...
  <div class="page-main">
    <div class="page-scroller">
      <ul class="demo">
        ...
        <li class="demo-item" @click="toast2">toast.loading的使用</li>
        <li class="demo-item" @click="alert">dialog.alert的使用</li>
        <li class="demo-item" @click="confirm">dialog.confirm的使用</li>
        <li class="demo-item" @click="dialog1">page-dialog1的使用</li>
        <li class="demo-item" @click="dialog2">page-dialog2的使用</li>
        <li class="demo-item" @click="dialog3">page-dialog3的使用</li>
      </ul>
    </div>
  </div>
